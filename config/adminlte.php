    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Header Banner and Texts',
                    'icon' => 'fa fw fa-image',
                    'url' => 'admin/banners/home',
                ],
                [
                    'text' => 'How It Works',
                    ...
                    'submenu' => [
                       [
                        ...
                        [
                            ...
                            'url' => 'admin/how-it-works/create',
                        ]
                    ]
                ],
                [
                    'text' => 'Investment Blocks',
                    'icon' => 'fa fw fa-money-check',
                    'submenu' => [
                        [
                            'text' => 'View List',
                            'icon' => 'fa fa-fw fa-list',
                        ...
                        [
                            'text' => 'Create',
                            'icon' => 'fa fa-fw fa-plus',
                            'url' => 'admin/investment/create',
                        ]
                    ],
                ],
                [
                    'text' => 'Additional',
                    'icon' => 'fa fw fa-info pull-right',
