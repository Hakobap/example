...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/style.css?v=' . $script_v = 140)}}"/>
    ...
    <style>
        ...
        .dashboard-site-filter option, .top-menu-item2 option {
            min-width: 155px;
            color: #000 !important;
        }
    </style>
        ...
        <nav class="navbar navbar-expand-md navbar-dark container">
            ...
            <div class="navbar-collapse collapse" id="collapsingNavbar">
                <div>
                    ...
                    <a href="{{ route('employee.task-management.tasks') }}">
