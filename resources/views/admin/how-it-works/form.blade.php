{{ Form::model($model, ['route' => ['admin.how-it-works.store', $model->id], 'enctype' => 'multipart/form-data']) }}

<div class="form-group has-feedback">
    <a style="font-size: 18px;" href="{{ route('admin.how-it-works.view') }}">Go To Back</a>
</div>
...
<div class="form-group has-feedback">
    {!! Form::label('extra', 'Sort Number:', ['class' => 'control-label']) !!}
    {!! Form::text('extra', $model->extra ,['id' => 'text', 'class' => 'form-control', 'required']) !!}
</div>

<div class="form-group has-feedback">
    {!! Form::label('file', 'Image (The Image Must Be 587x315 By Pixels):', ['class' => 'control-label']) !!}
